...
- [ ] **Resto (P3 del threat model §5)**: suite de SQL-injection/parametrización; breaker compartido al escalar el worker; secret-manager + rotación (ADR antes del sandbox); `trustProxy` acotado (PEND-006); SHA-pinning de actions de CI + frontend BuildKit
