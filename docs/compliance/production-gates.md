...
- [ ] **Resto (P3 del threat model §5)**: registro de aceptación de vulnerabilidades High/Critical + escaneo del SBOM (grype) gated; suite de SQL-injection/parametrización; breaker compartido al escalar el worker; secret-manager + rotación
