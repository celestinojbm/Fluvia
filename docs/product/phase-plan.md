...
Estado: Activo · Fase: 0 · Basado en V4 §50, ajustado con criterio propio (los ajustes están anotados)
...
| **4 — Conciliación y operaciones** | Operar lo construido | Reconciliation + casos, panel admin, reserves/fees/settlement/payout como abstracciones contables, runbooks | Gate Conciliación en verde; runbooks probados en drill |
