...
3. API keys: se almacena solo SHA-256; el secreto se muestra una única vez al crearse; prefijos identificables (`fluvia_sk_test_`, `fluvia_sk_live_`) para secret scanning propio y de GitHub.
